...
<div class="main-wrap">
    ...
    <div class="result-wrap">
        <div class="result-content">
            <form action="<?php echo U('Admin/Reply/update',['reply_id'=>$bbs_reply_data['reply_id']],'');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                <table class="insert-tab" width="100%">
                    <tbody>
                        <tr>
                            <th><i class="require-red">*</i>回复内容：</th>
                            <td>
                                <input class="common-text required" autocomplete="off" id="title" name="reply_content" size="50" value="<?php echo ($bbs_reply_data['reply_content']); ?>" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th></th>
                            <td>
                                ...
                                <a href="<?php echo U('Admin/Reply/index',['post_id'=>$bbs_reply_data['post_id']],'');?>" class="btn btn6">返回</a>
                            </td>
                        </tr>
                    </tbody></table>
            </form>
